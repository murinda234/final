...
namespace PaintApplicationAssignment
{
    public partial class Form1 : Form
    {
        ...
        private void Btn_save_Click(object sender, EventArgs e)
        {
            if (DrawingArea.Image != null)
            {
                ...
                sdf.Filter = "SVG files (*.svg)|*.svg|JPEG files (*.jpg)|*.jpg|PNG files (*.png)|*.png";
                    ...
                    List<string> elements = new List<string>
    {
                        ...
                        case 1: // SVG
                            {
                                ...
                                File.WriteAllText(sdf.FileName, svgCode);
        ...
        private void copyCtrlsToolStripMenuItem_Click(object sender, EventArgs e)
        {
